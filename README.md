...
| 14 | 考成 | 张居正 | 明 | `zhangjuzheng-kaocheng-14` |
| 15 | 虎门 | 林则徐 | 清 | `linzexu-humen-15` |
| 16 | 開皇 | 杨坚 | 隋 | `yangjian-kaihuang-16` |
| 17 | 東山 | 谢安 | 东晋 | `xiean-dongshan-17` |
| 18 | 汨羅 | 屈原 | 战国 · 楚 | `quyuan-miluo-18` |
| 19 | 昆陽 | 刘秀 | 东汉 | `liuxiu-kunyang-19` |
| 20 | 捫蝨 | 王猛 | 十六国 · 前秦 | `wangmeng-menshi-20` |
| 21 | 顯德 | 柴荣 | 五代 · 后周 | `chairong-xiande-21` |
| 22 | 輕重 | 管仲 | 春秋 · 齐 | `guanzhong-qingzhong-22` |
| 23 | 墮淚 | 羊祜 | 西晋 | `yanghu-duolei-23` |
| 24 | 大都 | 忽必烈 | 元 | `hubilie-dadu-24` |
| 25 | 符命 | 王莽 | 新 | `wangmang-fuming-25` |
| 26 | 江東 | 孙权 | 三国 · 东吴 | `sunquan-jiangdong-26` |
| 27 | 澶淵 | 萧绰 | 辽 | `xiaochuo-chanyuan-27` |
| 28 | 月明 | 李煜 | 十国 · 南唐 | `liyu-yueming-28` |
| 29 | 賀蘭 | 李元昊 | 西夏 | `liyuanhao-helan-29` |

> 共 **29 期 / 26 个朝代**（春秋 · 齐、战国 · 楚、秦、西汉、新、东汉、东汉末 · 曹魏、三国 · 蜀汉、
> 三国 · 东吴、西晋、东晋、十六国 · 前秦、北朝 · 北魏、南朝 · 刘宋、南朝 · 南梁、隋、唐、辽、
> 十国 · 南唐、五代 · 后周、北宋、西夏、南宋、元、明、清），
> 首页每页 3 期，共 10 页（29 = 3×9 + 2，末页 2 期为「明 / 清」）。
